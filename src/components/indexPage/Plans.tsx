	...
	return (
		<section id="planos" className="controle-secao controle-alternativa">
			<div className="controle-conteudo">
				...
				<p className="controle-subtexto">
					Reduza custos, aumente a recorrência e padronize o cuidado.
				</p>
				<div className="controle-planos-grid">
					<div
						className="controle-plano controle-revelar"
						data-plan="essencial"
					>
						<h4>Essencial</h4>
					...
					<div
						className="controle-plano controle-revelar controle-plano--destaque"
						data-plan="completo"
					>
						<h4>Completo</h4>
