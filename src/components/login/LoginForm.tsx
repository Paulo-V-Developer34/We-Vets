			...
			<div className="ControleTela">
				<div className="ControleEsquerda">
					...
					<div className="ControleFrase">
						...
						<p className="ControleMensagemEsq">
							Gerencie sua clínica com praticidade e segurança.
						</p>
					</div>
				...
				{/* <!-- Lado direito --> */}
				<main
					className="ControleDireita"
					role="main"
					aria-labelledby="ControleTitulo"
				>
					<div className="ControleLogin">
						...
						<h3 id="ControleTitulo" className="ControleTitulo">
							Acesse sua conta
						</h3>
						<p className="ControleSub">
							Gerencie agendamentos, prontuários e estoque da clínica.
						</p>
						...
						>
							...
							<div className="ControleLinha">
								<label className="ControleLembrar">
									<input type="checkbox" id="lembrar" /> Lembrar-me
								</label>
								<a href="#" id="ControleEsqueci" className="ControleLink">
									Esqueci minha senha
								</a>
							</div>
							...
							<div className="ControleBotoes">
								<button
									type="submit"
									className="ControleBotao ControlePrimario"
								>
									ENTRAR
								</button>
								<button
									type="button"
									className="ControleBotao ControleSecundario"
									id="ControleCriar"
								>
									CRIAR CONTA
								</button>
						...
						<footer className="ControleRodape">
							© <span id="anoAtual"></span> WeVet — Todos os direitos reservados
						</footer>
					</div>
				</main>
			</div>
